"""
Django settings for ecommerce_rs project.
...
SECRET_KEY = 'django-insecure-o9z%9gejkpx4!6n_0+$wxpy+g#@l1m*6$tm(qi#2#^)l%&m)e&'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.navbar_items',
            ],
        },
    },
]
